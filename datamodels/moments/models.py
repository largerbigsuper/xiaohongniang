...
class Moments(models.Model):
    ...
    comment = models.ManyToManyField('moments.Comments', db_table='lv_moment_comment', blank=True)
    comment_total = models.PositiveIntegerField(verbose_name='评论总数', default=0)
    like = models.ManyToManyField('moments.Likes', db_table='lv_comment_like', blank=True)
